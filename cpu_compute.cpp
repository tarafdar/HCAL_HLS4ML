...
int main(int argc, const char** argv){
    ...
    my_logger = spdlog::basic_logger_mt("basic_logger", "compute_log.txt"); 
#if LOG_LEVEL==0
    ...
    galapagos::node <T> node(kern_info, dest_ip_str, ext_drivers, my_logger);
