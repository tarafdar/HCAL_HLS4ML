...
open_project -reset hls4ml_hcal_prj
set_top hls4ml_hcal
add_files hls4ml_hcal.cpp -cflags "-I[file normalize ./nnet_utils] -std=c++0x"
add_files ereg_v1.cpp -cflags "-I[file normalize ./nnet_utils] -std=c++0x"
add_files -tb hls4ml_hcal_test.cpp -cflags "-I[file normalize ./nnet_utils] -std=c++0x"
